...
public class Event {
	...
	protected Event(String event_judul,String event_keterangan,String event_tanggal,String event_waktu,Clob event_foto) {
		super();
	...
	public Clob getEvent_foto() {
		return event_foto;
	}

	public void setEvent_foto(Clob event_foto) {
		this.event_foto = event_foto;
	}
}